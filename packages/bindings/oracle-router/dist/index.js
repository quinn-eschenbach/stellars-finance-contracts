...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["",
    ...
    fromJSON = {
        ...
        bump_oracle_state: (this.txFromJSON),
        get_oracle_config: (this.txFromJSON),
        set_oracle_config: (this.txFromJSON),
        set_oracle_sources: (this.txFromJSON)
    };
}
