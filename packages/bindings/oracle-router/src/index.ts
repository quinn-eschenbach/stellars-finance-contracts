...
export type StorageKey = {tag: "Initialized", values: void} | {tag: "ConfigManager", values: void} | {tag: "OracleConfig", values: void} | {tag: "Sources", values: readonly [string]} | {tag: "CachedPrice", values: readonly [string]} | {tag: "Version", values: void};
...
export interface Client {
   ...
   */
  initialize: ({admin, config_manager_address}: {admin: string, config_manager_address: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
        "",
        ...
        "AAAAAAAAAAAAAAAKaW5pdGlhbGl6ZQAAAAAAAgAAAAAAAAAFYWRtaW4AAAAAAAATAAAAAAAAABZjb25maWdfbWFuYWdlcl9hZGRyZXNzAAAAAAATAAAAAA==",
