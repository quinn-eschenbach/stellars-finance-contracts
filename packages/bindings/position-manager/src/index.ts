...
export interface Client {
   ...
   */
  increase_position: ({trader, symbol, size, collateral, is_long, take_profit, stop_loss}: {trader: string, symbol: string, size: i128, collateral: i128, is_long: boolean, take_profit: i128, stop_loss: i128}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
