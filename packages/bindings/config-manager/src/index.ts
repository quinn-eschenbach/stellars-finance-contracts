...
export type StorageKey = {tag: "Initialized", values: void} | {tag: "Admin", values: void} | {tag: "RoleMember", values: readonly [RoleMemberKey]} | {tag: "FeeSplits", values: void} | {tag: "ProtocolLimits", values: void} | {tag: "BorrowRateConfig", values: void} | {tag: "Version", values: void};
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
